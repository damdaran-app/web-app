      ...
      <div className="holder flex flex-col items-center">
        ...
        <div className="qustion-item-container my-8">
          <QuestionsSection
            ...
            questionData={reportData.data.ourPositivePoints?.tips ?? [{tipsTitle: "", tipsDescription: ""}]}
          />
        </div>
        <SectionFrequentlyAskedQuestions
          ...
          questionsData={reportData.data.frequentlyAskedQuestions ?? [{question: "", answerToTheQuestion: ""}]}
        />
        <div
